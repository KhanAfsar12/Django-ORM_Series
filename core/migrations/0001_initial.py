# Generated by Django 5.1.3 on 2025-02-09 17:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, validators=[core.models.validate_reataurant_name_begins_with_a])),
                ...
                ('restaurant_type', models.CharField(choices=[('IN', 'Indian'), ('CH', 'Chinese'), ('IT', 'Italian'), ('GR', 'Greek'), ('FF', 'Fast Food'), ('MX', 'Maxican'), ('OT', 'Other')], max_length=2)),
            ],
            options={
